    ...
    <View>
      <Table>
        <TH>
          ...
          <TD style={{ flex: 3 , width:'100%', display:'flex', alignItems:'center', justifyContent:'center', flexDirection:'column', paddingTop:'1',paddingBottom:'1' }}>
            <Text style={{border:'0', width:'100%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center' }}>FORMATIVE</Text>
          ...
          <TD style={{ flex: 3, width:'100%', display:'flex', alignItems:'center', justifyContent:'center', flexDirection:'column', paddingTop:'1',paddingBottom:'1'}}>
             <Text style={{border:'0', width:'100%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center' }}>SUMMATIVE</Text>
            <Text style={{border:'0', width:'100%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center',paddingBottom:2}}>ASSESSMENT</Text>
          </TD>
          <TD style={{ flex: 2 }}>
          ...
          return !is_registered?null:(
            <TR key={i} style={{display:'flex', alignItems:'center', justifyContent:'center',marginTop:4}}>
              ...
              <TD style={{ flex: 3,height: "25", borderTop:'0' }}>
                ...
                >{isRegistered(sub['AOI'], sub['EOA(80)']) && roundOff(sub['AOI'],1)}</TD>
                <TD
                  style={{
                    height: "100%",
                    width:"100%",
                ...
                >{isRegistered(sub['AOI'], sub['EOA(80)']) && roundOff(sub['AOI(20)'],0)}</TD>
              </TD>
              <TD style={{ flex: 3, height: "25", borderTop:'0' }}>
                <TD
                  style={{
                ...
                >{isRegistered(sub['AOI'], sub['EOA(80)']) && roundOff(sub['EOA(80)'],0)}</TD>
                <TD
                  style={{
                    height: "100%",
                    width:'100%',
                ...
                >{isRegistered(sub['AOI'], sub['EOA(80)']) && roundOff(sub['TOTAL'],0)}</TD>
              </TD>
              <TD style={{ flex: 2, height: "25", borderTop:'0' }}>
                ...
                >{isRegistered(sub['AOI'], sub['EOA(80)']) && roundOff(sub['GRADE'],1)}</TD>
              </TD>            
              <TD style={{ flex: 4, height: "25", borderTop:'0',fontStyle:'italic'}}> {" "}{sub['COMM']}</TD>
              <TD style={{ flex: 1, height: "25", borderTop:'0' }}>
                ...
                >{isRegistered(sub['AOI'], sub['EOA(80)']) && sub['TOTAL']?sub['INIT']:''}</TD>
              </TD>  
            </TR>
        )})}
      </Table>
